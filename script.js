...
const paymentRadios = document.querySelectorAll('input[name="payId"]');


paymentRadios.forEach(radio => {
    radio.addEventListener('change', function() {
        // Verifica se algum dos inputs de pagamento está selecionado
        const isPaymentSelected = [...paymentRadios].some(radio => radio.checked);
        if (isPaymentSelected) {
            payWarn.classList.add("hidden"); // Esconde a mensagem de aviso
        }
    });
});
...
checkoutBtn.addEventListener("click", function(){
    ...
    const selectedPayment = document.querySelector('input[name="payId"]:checked');
    if (!selectedPayment) {
